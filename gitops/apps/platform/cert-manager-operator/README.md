...
- The defaults match the current OpenShift 4.20 operator guidance. This chart uses automatic approval because certificate CRDs are a shared platform dependency.
